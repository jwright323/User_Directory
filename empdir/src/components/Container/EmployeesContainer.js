...
import EmployeeTable from "../EmployeeTable/index.js";
...
class EmployeesContainer extends Component {
    ...
    // When this component mounts, load random users using API from https://randomuser.me/
    componentDidMount() {
        API.getEmployees()
            .then((res) =>
                this.setState({
    ...
    // Sort with the key of columned click.
        ...
        this.setState({
            filteredEmployees: this.state.employees.filter((employee) => {
                return (
                    ...
                    employee.phone.replace(/[^\w\s]/g, "").includes(input) ||
